  ...
  return (
    <div className="relative">
      ...
      <div
        ref={setNodeRef}
        style={style}
        className={`group flex items-center gap-1 px-2 py-1.5 rounded cursor-pointer transition-all ${
          isSelected
            ? 'bg-blue-100 text-blue-700'
            : 'hover:bg-gray-100 text-gray-700'
        } ${isDragging || isBeingDragged ? 'opacity-50 ring-2 ring-blue-400 scale-[1.02]' : ''} ${
